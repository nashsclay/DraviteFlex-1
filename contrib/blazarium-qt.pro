...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/draviteflex-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/draviteflex-cli.cpp \
           src/draviteflex-tx.cpp \
           src/draviteflex.cpp \
           src/db.cpp \
           ...
           src/qt/draviteflex.cpp \
           src/qt/draviteflexstrings.cpp \
...
RESOURCES += src/qt/draviteflex.qrc src/qt/draviteflex_locale.qrc

TRANSLATIONS += src/qt/locale/draviteflex_bg.ts \
                src/qt/locale/draviteflex_de.ts \
                src/qt/locale/draviteflex_en.ts \
                src/qt/locale/draviteflex_es.ts \
                src/qt/locale/draviteflex_fi.ts \
                src/qt/locale/draviteflex_fr.ts \
                src/qt/locale/draviteflex_it.ts \
                src/qt/locale/draviteflex_ja.ts \
                src/qt/locale/draviteflex_pl.ts \
                src/qt/locale/draviteflex_pt.ts \
                src/qt/locale/draviteflex_ru.ts \
                src/qt/locale/draviteflex_sk.ts \
                src/qt/locale/draviteflex_sv.ts \
                src/qt/locale/draviteflex_vi.ts \
                src/qt/locale/draviteflex_zh_CN.ts \
                src/qt/locale/draviteflex_zh_TW.ts
