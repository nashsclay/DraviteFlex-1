...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DraviteCoins server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DraviteCoins server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DRV features */
        {"dravitecoins", "masternode", &masternode, true, true, false},
        {"dravitecoins", "masternodelist", &masternodelist, true, true, false},
        {"dravitecoins", "mnbudget", &mnbudget, true, true, false},
        {"dravitecoins", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"dravitecoins", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dravitecoins", "mnsync", &mnsync, true, true, false},
        {"dravitecoins", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"dravitecoins", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dravitecoinsd, or the -server option to dravitecoins-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               "It is recommended you use the following random password:\n"
                                               "rpcuser=dravitecoinsrpc\n"
                                               "rpcpassword=%s\n"
                                               "(you do not need to remember this password)\n"
                                               "The username and password MUST NOT be the same.\n"
                                               "If the file does not exist, create it with owner-readable-only file permissions.\n"
                                               "It is also recommended to set alertnotify so you are notified of problems;\n"
                                               "for example: alertnotify=echo %%s | mail -s \"DraviteCoins Alert\" admin@foo.com\n"),
...
{
    return "> dravitecoins-cli " + methodname + " " + args + "\n";
}
