...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-anonymizedraviteflexamount=<n>", strprintf(_("Keep N DRV anonymized (default: %u)"), 0));
...
// ********************************************************* Step 8: load wallet
    ...
    nAnonymizeDRVAmount = GetArg("-anonymizedraviteflexamount", 0);
