...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DraviteFlex Core draviteflex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  draviteflex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded draviteflex transaction") + "\n" +
                               "  draviteflex-tx [options] -create [commands]   " + _("Create hex-encoded draviteflex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded draviteflex transaction
