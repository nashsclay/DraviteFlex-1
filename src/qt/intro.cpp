...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DraviteCoins Core"),
     ...
     * override -datadir in the dravitecoins.conf file in the default data directory
     * (to be consistent with dravitecoinsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
