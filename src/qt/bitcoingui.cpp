                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DraviteFlex-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DraviteFlex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and draviteflex: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DraviteFlex Core"), this);
    aboutAction->setStatusTip(tr("Show information about DraviteFlex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DraviteFlex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DraviteFlex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DraviteFlex addresses"));
    ...
    openAction->setStatusTip(tr("Open a DraviteFlex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DraviteFlex Core help message to get a list with possible DraviteFlex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DraviteFlex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DraviteFlex network", "", count));
}
...
{
    QString strTitle = tr("DraviteFlex Core"); // default title
