                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DraviteCoins-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DraviteCoins address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dravitecoins: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DraviteCoins Core"), this);
    aboutAction->setStatusTip(tr("Show information about DraviteCoins Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DraviteCoins"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DraviteCoins addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DraviteCoins addresses"));
    ...
    openAction->setStatusTip(tr("Open a DraviteCoins: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DraviteCoins Core help message to get a list with possible DraviteCoins command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DraviteCoins Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DraviteCoins network", "", count));
}
...
{
    QString strTitle = tr("DraviteCoins Core"); // default title
