...
/** Utility functions used by the DRV Qt UI.
 */
namespace GUIUtil
{
...
// Render DRV addresses in monospace font
...
// Parse "dravitecoins:" URI into recipient object, return true on successful parsing
