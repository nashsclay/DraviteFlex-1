...
/** Utility functions used by the DRVF Qt UI.
 */
namespace GUIUtil
{
...
// Render DRVF addresses in monospace font
...
// Parse "draviteflex:" URI into recipient object, return true on successful parsing
